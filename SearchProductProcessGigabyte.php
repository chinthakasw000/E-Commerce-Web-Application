...
`product`.`id` WHERE `product`.`name` LIKE '%gigabyte%'";
...
if ($num2 == 0) {
    ...
    <h1><img src="Resources/icon/brand_icon/gigabyte.png" width="200" alt=""></h1>
        <h1><img src="Resources/photo/index/icon/cry.png" width="200" alt=""></h1>
        <h5>All Gigabyte Laptop  Sold Out</h5>
    ...
    for ($i = 0; $i < $num2; $i++) {
     ...
     <!-- card  -->
     <div class="d-flex justify-content-center col-12 col-sm-6 col-md-4 col-lg-3 mt-3">
